...
<div class='layout_middle review_layout_middle reviews_toplist_layout_middle'>
  ...
  <h2><?php echo $this->translate('Most Recommended Members')?></h2>
  <div><?php echo $this->translate('Below are our most recommended members sorted by number of recommendations a member has gotten.')?></div>
<?php if ($this->stats): ?>

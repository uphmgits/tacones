...
/////////////////////////////////////////
          ...
          $this->view->mycatid =  $id2 = $marketplace->category_id;    
	
Engine_Api::_()->marketplace()->tree_list($id2);

        //$categ2 = implode(', ', Engine_Api::_()->marketplace()->_inarr);

        $a_tree2 = Engine_Api::_()->marketplace()->tree_list_load_array(array($id2));

        $this->view->a_tree2 = $a_tree2;
        $this->view->urls2 = $this->_helper->url;	
/////////////////////////////////////////////////////////			

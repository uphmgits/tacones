...
//class Marketplace_Plugin_Paypal {
class Marketplace_Api_Paypal extends Core_Api_Abstract {
   ...
   function paypal_class() {
      ...
      $this->paypal_url = 'https://www.sandbox.paypal.com/cgi-bin/webscr';//www.paypal.com/cgi-bin/webscr';

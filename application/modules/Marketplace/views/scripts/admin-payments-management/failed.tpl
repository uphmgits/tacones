<h2><?php echo $this->translate("Management of Failer Orders") ?></h2>
    ...
    <tbody>
      <?php foreach( $this->paginator as $item ): ?>
        ...
        <?php if( $buyer and $marketplace and !empty( $marketplace->business_email ) ) : ?>
          ...
          <?php $paypal->setControllerUrl("http://" . $_SERVER['HTTP_HOST'] . $this->url(array(), 'marketplace_extended', true) . '/paymentfailed'); ?>
          <?php $isPPButton = true; ?>
        <?php endif; ?>

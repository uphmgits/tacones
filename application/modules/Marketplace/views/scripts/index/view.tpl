	  ...
	  <div class='marketplaces_gutter'>
		...
		<ul class='marketplaces_gutter_options'>
		  ...
		  <?php if ($this->marketplace->owner_id == $this->viewer->getIdentity()||$this->can_edit):?>
			<li>
			  <a href='<?php echo $this->url(array('marketplace_id' => $this->marketplace->marketplace_id), 'marketplace_edit', true) ?>' class='buttonlink icon_marketplace_edit'><?php echo $this->translate('Testing...Edit This Listing');?></a>
			</li>

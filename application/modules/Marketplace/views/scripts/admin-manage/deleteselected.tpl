...
<div class='global_form'>
  ...
  <form method="post">
    <div>
      <h3><?php echo $this->translate("Delete the selected marketplace listings?") ?></h3>
      <p>
        <?php echo $this->translate("Are you sure that you want to delete the %d marketplace listings? It will not be recoverable after being deleted.", $this->count) ?>
      </p>
      <br />
      <p>
  ...
  <?php else: ?>
    <?php echo $this->translate("Please select a marketplace listing to delete.") ?> <br/><br/>

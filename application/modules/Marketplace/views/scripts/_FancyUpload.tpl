 ...
 * * 
 * @version    $Id: _FancyUpload.tpl 7244 2010-09-01 01:49:53Z john $
 * @author     Sami
 */
?>
		...
		onFileStart: function() {
		  ...
		  file_id = file.photo_id;
                  request = new Request.JSON({
                   'format' : 'json',
                   'url' : '<?php echo $this->url(Array('module'=>'marketplace', 'controller' => 'photo', 'action'=>'remove'), 'default') ?>',
                   'data': {
                     'photo_id' : file_id
                   },
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo list to save them to your marketplace listing.');?>
  </div>
  <div>
